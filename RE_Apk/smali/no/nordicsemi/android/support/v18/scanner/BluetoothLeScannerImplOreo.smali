...
.method private createStartingPendingIntent(Ljava/util/List;Lno/nordicsemi/android/support/v18/scanner/ScanSettings;Landroid/content/Context;Landroid/app/PendingIntent;)Landroid/app/PendingIntent;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    const-class v2, Lno/nordicsemi/android/support/v18/scanner/PendingIntentReceiver;

    invoke-direct {v1, p3, v2}, Landroid/content/Intent;-><init>(Landroid/content/Context;Ljava/lang/Class;)V

    const-string v2, "no.nordicsemi.android.support.v18.ACTION_FOUND"
    ...
    invoke-virtual {v1, p4, p1}, Landroid/content/Intent;->putParcelableArrayListExtra(Ljava/lang/String;Ljava/util/ArrayList;)Landroid/content/Intent;

    const/4 p1, 0x1

    .line 164
    invoke-virtual {p0, v2, p2, p1}, Lno/nordicsemi/android/support/v18/scanner/BluetoothLeScannerImplOreo;->toNativeScanSettings(Landroid/bluetooth/BluetoothAdapter;Lno/nordicsemi/android/support/v18/scanner/ScanSettings;Z)Landroid/bluetooth/le/ScanSettings;
    ...
    .line 171
    invoke-static {p3, v0, v1, p1}, Landroid/app/PendingIntent;->getBroadcast(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
...
.method private createStoppingPendingIntent(Landroid/content/Context;Landroid/app/PendingIntent;)Landroid/app/PendingIntent;
    .locals 2
...
.method startScanInternal(Ljava/util/List;Lno/nordicsemi/android/support/v18/scanner/ScanSettings;Landroid/content/Context;Landroid/app/PendingIntent;)V
    ...
    .line 99
    invoke-virtual {p0, v0, p2, v3}, Lno/nordicsemi/android/support/v18/scanner/BluetoothLeScannerImplOreo;->toNativeScanSettings(Landroid/bluetooth/BluetoothAdapter;Lno/nordicsemi/android/support/v18/scanner/ScanSettings;Z)Landroid/bluetooth/le/ScanSettings;
    ...
    .line 110
    invoke-direct {p0, v2, p2, p3, p4}, Lno/nordicsemi/android/support/v18/scanner/BluetoothLeScannerImplOreo;->createStartingPendingIntent(Ljava/util/List;Lno/nordicsemi/android/support/v18/scanner/ScanSettings;Landroid/content/Context;Landroid/app/PendingIntent;)Landroid/app/PendingIntent;

    move-result-object p1

    .line 112
    invoke-virtual {v1, v4, v3, p1}, Landroid/bluetooth/le/BluetoothLeScanner;->startScan(Ljava/util/List;Landroid/bluetooth/le/ScanSettings;Landroid/app/PendingIntent;)I
...
.method stopScanInternal(Landroid/content/Context;Landroid/app/PendingIntent;)V
    ...
    .line 123
    invoke-direct {p0, p1, p2}, Lno/nordicsemi/android/support/v18/scanner/BluetoothLeScannerImplOreo;->createStoppingPendingIntent(Landroid/content/Context;Landroid/app/PendingIntent;)Landroid/app/PendingIntent;
